...
class TestConcentrate(unittest.TestCase):
    ...
    def test1(self):
        ...
        output_file = tmp_dir + "/concentrate_sv_list.txt"
        answer_file = cur_dir + "/data/concentrate/concentrate_sv_list.txt"


        args = self.parser.parse_args(["concentrate", result_lsit_file, output_file])
        args.func(args)
