...
class TestCount(unittest.TestCase):
    ...
    def test1(self):
        ...
        output_file = tmp_dir + "/CCLE.genomonSV.result.count.txt"
        answer_file = cur_dir + "/data/count/CCLE.genomonSV.result.count.txt"
 
        args = self.parser.parse_args(["count", result_lsit_file, output_file])
        args.func(args)
